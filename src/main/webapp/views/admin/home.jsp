...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img src="<c:url value='/templates/admin/dist/img/vuong.jpg'/>" alt="User Avatar"
									class="img-size-50 mr-3 img-circle">
								<div class="media-body">
									<h3 class="dropdown-item-title">
										 Vương Crystal <span class="float-right text-sm text-danger"><i
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img src="
									<c:url value='/templates/admin/dist/img/hai.jpg'/>" alt="User Avatar"
									class="img-size-50 img-circle mr-3">
								<div class="media-body">
									<h3 class="dropdown-item-title">
										Trần Nguyên Hải  <span class="float-right text-sm text-muted"><i
											class="fas fa-star"></i></span>
									</h3>
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img src="<c:url value='/templates/admin/dist/img/nam.jpg'/>" alt="User Avatar"
									class="img-size-50 img-circle mr-3">
								<div class="media-body">
									<h3 class="dropdown-item-title">
										Hoài Nam <span class="float-right text-sm text-warning"><i
											class="fas fa-star"></i></span>
									</h3>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="#" class="brand-link"> <img src="
				<c:url value='/templates/admin/dist/img/AdminLTELogo.png'/>" alt="AdminLTE Logo"
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="
							<c:url value='/templates/admin/dist/img/profile.jpg'/>" class="img-circle elevation-2"
							alt="User Image">
					</div>
					<div class="info">
	...
	<script>
		...
		$('#selectVideo').change(function(){
			...
			}).done(function(data){ /* dùng done cho data table */			
			$('#example2').DataTable({
				destroy: true,
				"paging" : true,
				"lengthChange" : false,
				...
				"aaData": data,
				"columns": [
					{"data": "username"}, /* muon lay thuoc tinh gi thi khai bao ra */
					{"data": "email"}
				]
			});
			}).fail(function(error){
