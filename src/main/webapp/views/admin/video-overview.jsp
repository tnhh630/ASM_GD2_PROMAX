...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="http://localhost:8080/ASM_GD2_PROMAX/index" class="nav-link">Home</a></li>
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img src="<c:url value='/templates/admin/dist/img/nghia.jpg'/>" alt="User Avatar"
									class="img-size-50 mr-3 img-circle">
								<div class="media-body">
									<h3 class="dropdown-item-title">
										Nghĩa Trần <span class="float-right text-sm text-danger"><i
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img src="
									<c:url value='/templates/admin/dist/img/user8-128x128.jpg'/>" alt="User Avatar"
									class="img-size-50 img-circle mr-3">
								<div class="media-body">
									<h3 class="dropdown-item-title">
										Hoài Bão <span class="float-right text-sm text-muted"><i
											class="fas fa-star"></i></span>
									</h3>
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								...
								<div class="media-body">
									<h3 class="dropdown-item-title">
										Nhật Hào <span class="float-right text-sm text-warning"><i
											class="fas fa-star"></i></span>
									</h3>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="#" class="brand-link"> <img src="<c:url value='/templates/admin/dist/img/AdminLTELogo.png'/>" alt="AdminLTE Logo"
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="<c:url value='/templates/admin/dist/img/profile.jpg'/>" class="img-circle elevation-2"
							alt="User Image">
					</div>
					<div class="info">
               ...
               with font-awesome or any other icon font library -->
						...
						<i class="nav-icon fas fa-tachometer-alt"></i>
								<p>
									...
									<!--  dau mui ten xuong ben phai -->
								</p>
						</a>
							<ul class="nav nav-treeview">
								<li class="nav-item">
								<a href="<c:url value='/admin/video?action=view'/>" class="nav-link active" > <i class="far fa-circle nav-icon"></i>
										<p>Overview</p>
								</a></li>
								<li class="nav-item"><a href="<c:url value='/admin/video?action=add'/>" class="nav-link"> 
								...
								<tr>
									<c:forEach items="${videos}" var="item">
										<tr class="text-center">
											...
											<td> <a href="http://localhost:8080/ASM_GD2_PROMAX/video?action=watch&id=${item.href}">${item.href}</a></td>
											<td>
												<img src="${item.poster}" alt="" width="150px" height="150px"/>
											</td>
											
											<td>
											<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>" type="button" class="btn btn-block btn-info btn-sm p-3 mt-3 "> Edit</a>
											<button  type="button"  onclick="deleteVideo('${item.href}')" class="btn btn-block btn-danger btn-sm p-3"> Delete</button>
											</td>
										</tr>
									</c:forEach>
								</tr>
		...
		<footer class="main-footer">
			<strong>Copyright &copy; 2021 <a
				href="https://caodang.fpt.edu.vn/">Polytechnic</a>.
	...
	<script>
 	...
 	function deleteVideo(href){
		...
		$.ajax({
			url: '/ASM_GD2_PROMAX/admin/video?action=delete&href=' + href
		}).then(function(data){
			window.location.href= "http://localhost:8080/ASM_GD2_PROMAX/admin/video?action=view";
		}).fail(function(error){
